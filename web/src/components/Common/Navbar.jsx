...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex lg:h-[68px] nav-h-52">
      <nav
        className={`z-10 top-0 flex w-full lg:h-[68px] nav-h-52 border-b-[0.5px] border-b-[#747474aa] justify-between xl:px-[1px] lg:px-[1px] md:px-[56px] nyxContainer fixed  ${open ? "" : ""
          } bg-[#070C10]`}
      >
        <div className="flex items-center nav-y-p justify-center xl:w-[10%] lg:w-[10%] xl:pl-0 lg:pl-0 pl-[20px] xl:border-r-[0.5px] lg:border-r-[0.5px] border-l-[0.5px] border-[#747474aa] lg:border-s-0">
        ...
        <div className="w-[70%] pl-[10%] xl:flex lg:flex hidden font-[RobotoMono] text-[15px]">
        ...
        <div className="flex items-center justify-center xl:w-[20%] lg:w-[20%] w-[40%]">
          <div className="justify-center items-center xl:flex lg:flex md:flex hidden w-[50%] xl:">
        ...
        <div
          className={`flex xl:hidden lg:hidden items-center justify-center border-r-[0.5px] border-[#747474aa] xl:pr-0 lg:pr-0  ${open ? "" : "pr-[20px]"
            }`}
        >
          {open ? (
            <button
            ...
            <div>
              <ul className="app__navbar-smallscreen_links mt-7 pb-10">
                ...
                <li
                  style={{ "--delay": 0.6 + "s" }}
                  onClick={() => handleOpen(false)}
                  className="animate-slideIn opacity-0 text-xl text-white mt-[26px] p-0 hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-[4px] before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:absolute before:left-0 before:bottom-0"
                >
                  <a
                    href="#contact"
                ...
                <li
                  style={{ "--delay": 0.7 + "s" }}
                  onClick={() => handleOpen(false)}
                  className="animate-slideIn opacity-0 text-xl text-white p-0 border-b-[0.5px] border-[#747474aa] hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-[4px] before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:absolute before:left-0 before:bottom-0"
                >
                  <a
                    href="#contact"
                    className="flex items-center justify-center"
